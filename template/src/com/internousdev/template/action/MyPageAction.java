...
public class MyPageAction extends ActionSupport implements SessionAware{
	...
	public String execute() throws SQLException{
		...
		if(deleteFlg == null){
			...
			/////★
			System.out.println(myPageDTO.getItemName());
			System.out.println(myPageDTO.getTotalPrice());
			System.out.println(myPageDTO.getTotalCount());
			System.out.println(myPageDTO.getPayment());
			/////★
